function [l_out,u_out,n_i] = ApplyFixings(B_star,l_in,u_in,x_0,V,Last_MU_Multipliers_BundlePhase_For_BlockTimes,n)
...
for i = 1:length(B_star);
    temp = double(capCons(:,:,B_star(i))).*Last_MU_Multipliers_BundlePhase_For_BlockTimes;
...
while indicator == 0;
    ...
    integer_variables = size(find(l_temp == 1),1);
    ...
    elseif length(B_star) == 1;
        ...
        %update our indicator accordingly
        indicator = 1;
    end
